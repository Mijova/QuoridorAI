...
def main():
    ...
    for episode in range(1, EPISODES+1):
        ...
        while not state.is_terminal():
            ...
            rotated_state_action_q_values = state_action_q_values if state.current_player() == 0 else state_action_q_values[0][ROTATION_MASK]
        ...
        if (episode %  500 == 0 or episode == 100):
            torch.save(agent, f"/mnt/QuoridorAI/Agents/r2SelfLearnedER{BOARD_SIZE}x{BOARD_SIZE}-{episode}")
    end = time.time()
